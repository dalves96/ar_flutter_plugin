...
class ArFlutterPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(
    ...
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "ar_augmented_faces")
  ...
  override fun onAttachedToActivity(binding: ActivityPluginBinding) {
    this.flutterPluginBinding.platformViewRegistry.registerViewFactory(
        "ar_augmented_faces", AndroidARViewFactory(binding.activity, flutterPluginBinding.binaryMessenger))
  }
